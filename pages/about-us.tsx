    ...
    return (
        <PageLayout PAGE_SEO={PAGE_SEO} home>
            <section className='container px-3 md:pb-20 md:pt-10 pt-20'>
                <div className="">
                    <a href={MINE.social?.[0]?.link} target="_blank" rel="noopener noreferrer" className="block md:w-[15%] w-[50%] ">
                        <img src="/images/main-icon.jpg" alt="webexpe.com" className="rounded-lg overflow-hidden" />
                    </a>
