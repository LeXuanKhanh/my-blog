...
const Home = () => {
  const PAGE_SEO: iSEO = {
    title: 'My little playground',
    description: `Just a simple blog.`,
    keywords: 'superatom, khanh le xuan',
}

  return (
    <PageLayout home PAGE_SEO={PAGE_SEO}>
      <section className='w-full md:pt-[100px] md:pb-[70px] pt-[130px] pb-20 mb-10 dark:bg-slate-800 bg-slate-200'>
        <div className="container text-left px-3">
          <Text subtitle>
            Welcome to my blog, where I note my thing, you may find something useful here :)
          </Text>
